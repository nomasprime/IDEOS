...
{% set state_lib_dir = "{0}/states/{1}/files/Library/".format(pillar.pwd, application) %}
{% set application_support = salt['pillar.get']("{0}:files:library:application_support".format(application), False) %}
