...
.clone_repository:
  cmd.run:
    - name: git clone git@github.com:chriskempson/base16-shell.git {{ pillar.global.user.home }}/.config/base16-shell
    - creates: {{ pillar.global.user.home }}/.config/base16-shell
    - require:
      - sls: git
